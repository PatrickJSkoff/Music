...
public final class Methods {
    /*
    Tell Jakarta Faces that you want to keep the FacesMessage messages in the Flash scope.
    --------------------------------------------------------------
    *** This is required when you redirect to show a Jakarta Faces page. ***
    --------------------------------------------------------------
    ...
    /*
    We display FacesMessage messages using p:growl in an overlay on all Jakarta Faces pages by including the
