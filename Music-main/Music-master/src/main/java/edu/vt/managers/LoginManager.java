...
public class LoginManager implements Serializable {
    ...
    /*
    The @Inject annotation directs the CDI Container Manager to inject (store)
    the object reference of the CDI container-managed EmailController bean into
    the instance variable 'emailController' after it is instantiated at runtime.
     */
    @Inject
    ...
    object reference of the CDI container-managed TextMessageController bean into
    the instance variable 'textMessageController' after it is instantiated at runtime.
     */
    @Inject
    ...
    //=====================================
    // Authenticate User to Sign In (Login)
    //=====================================
    ...
    //==============================================================================
    // This method is used to show a Jakarta Faces (XHTML) page when the page cannot
    // be returned, e.g., return "/userAccount/Profile?faces-redirect=true";
    ...
    public void redirectToShowJSFpage(String jsfPageUri) {
        ...
        /*
         ...
         Obtain the URI of the Jakarta Faces (XHTML) page to redirect to with respect to webapp directory.
         Example jsfPageUri: "/userAccount/Profile.xhtml"
         */
        String redirectPageURI = externalContext.getRequestContextPath() + jsfPageUri;

        // Execute the redirect to show the Jakarta Faces (XHTML) page
        try {
