...
/*
 ...
 Using the Expression Language (EL) in Jakarta Face XHTML page, you can invoke a CDI-managed
...
public class EmailController {
    ...
    public void sendEmail() throws AddressException, MessagingException {
        ...
        try {
            ...
            CloudSDatVT@gmail.com account's "Allow less secure apps" option is set to ON.
             */
            transport.connect("smtp.gmail.com", "CloudSDatVT@gmail.com", "mgfkorlebrcljhjl");
