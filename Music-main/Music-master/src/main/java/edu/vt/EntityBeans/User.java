...
// The @Entity annotation designates this class as a Jakarta Persistence Entity POJO class representing the database table User.
@Entity
...
@NamedQueries({
        ...
        , @NamedQuery(name = "User.findByState", query = "SELECT u FROM User u WHERE u.stateName = :stateName")
